...
$id_sujet = $_GET['id'];
$ref_inscrit = 1; // $_SESSION['id_inscrit']

$stmt = $connexion->prepare("
    SELECT sujet.*, inscrit.pseudo
    FROM sujet
...
<nav class="navbar navbar-expand-sm navbar-light bg-light border border-danger border-3">
    <div class="container d-flex justify-content-evenly align-items-center">
        <a href="acceuil.php"><img alt="UniVoix Logo" class="navbar-brand fw-bold" src="../img/univoix.png" style="max-width:50px;"></a>
    ...
    <div class="card border border-danger border-3 shadow-sm rounded-4 mb-5">
        <div class="card-body p-5">
            ...
            <div class="d-flex align-items-start gap-3 mb-4">
                ...
                <div>
                    <div class="fw-bold text-dark fs-5"><?= htmlspecialchars($sujet['pseudo']) ?></div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-start gap-3 mb-3">
                        ...
                        <div class="bg-secondary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="min-width: 45px; height: 45px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person text-secondary" viewBox="0 0 16 16">
                                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                            </svg>
                        </div>
